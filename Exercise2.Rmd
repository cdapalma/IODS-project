...
# define the visualization type (points)
p2 <- p1 + geom_point()+ ggtitle("Chart p2")
...
# fit a linear model
my_model <- lm(Points ~ attitude + deep, data = learning2014)
...
<br> We will focus on plots 1, 2 and 5: Residuals vs Fitted values, Normal QQ-plot and Residuals vs Leverage.
...
# creation a regression model with multiple explanatory variables
my_model2 <- lm(points ~ attitude + stra, data = learning2014)
